 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 80 // BAKA MOD 40        // Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 10 // BAKA MOD 4     // Degrees Celsius
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 40 // BAKA MOD 20                // Seconds
  #define WATCH_TEMP_INCREASE 4 // BAKA MOD 2               // Degrees Celsius
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD 40 // BAKA MOD 20    // Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS 4 // BAKA MOD 2 // Degrees Celsius
